        ...
        <div className='w-full sm:w-1/2'>
            <div className='flex flex-col gap-2'>
                ...
                <div className='flex gap-5 mt-7'>
                    <a  target='_blank' rel='noreferrer' className='flex items-center bg-[#ec6e59] text-white px-4 py-2 rounded-md text-sm'>
                    {/* <a href={live} target='_blank' rel='noreferrer' className='flex items-center bg-[#ec6e59] text-white px-4 py-2 rounded-md text-sm'> */}
                        Demo
                    </a>
                    <a  target='_blank' rel='noreferrer' className='flex items-center gap-1 px-4 py-2 border border-black rounded-md text-sm bg-white dark:bg-[#20262E]'>
