      ...
      <div className="flex flex-col sm:flex-row sm:items-center pt-0 justify-center w-full min-h-[58vh] tm:min-h-min tm:w-full sm:min-h-min sm:w-full sm:pt-0 tm:pt-0">
        <div className="flex flex-col justify-center sm:w-[70%] w-full sm:mr-5">
          ...
          <p className="dark:text-[#ccc] text-justify leading-loose pt-5 font-[400] mt-[-.8rem] text-custom-18 sm:text-[1rem] w-[90%] md:w-[95%] tm:w-full sm:w-full sm:mt-0">
            I am a Front-End Developer with over 2 years of experience designing
            and building dynamic, user-centric web applications. I specialize in
            HTML , CSS , JavaScript , and React .In addition to development, I
            also take on the role of designing user interfaces. A key part of my
            work involves visually representing complex business data through
            interactive charts and dashboards, enabling stakeholders to easily
        ...
        <div className="flex place-content-center mt-7 ">
          <div className="flex flex-row sm:flex-col gap-4">
            <a
              rel="noreferrer"
              // href="https://www.linkedin.com/in/rimsha-6b2407198"
              target="_blank"
            >
            ...
            <a
              rel="noreferrer"
              href="https://github.com/siva-balan-rg"
              target="_blank"
            >
